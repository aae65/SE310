 ...
 * smaller than / equal to 50,000 liters and 128 cylinders.
 */
...
public class Engine implements Serializable {
    ...
    private static final double MAX_LITERS = 50000.0;
    private static final int MAX_CYLINDERS = 128;
    ...
    /**
     * Different vehicle types have different MPG efficiency. Allow a vehicle to modify
     * the default MPG calculation if they choose to do that.
     * @param newMPG The modified MPG rating for this engine
     */
    public void modifyMPGRating(double newMPG){
        this.engineMPG = newMPG;
    }
